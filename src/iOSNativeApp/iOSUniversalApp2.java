...
public class iOSUniversalApp2 {
	...
	public static void main(String[] args) throws Exception {
			...
			iOSUniversalApp2.setupWebDriver();
			//iOSUniversalApp2.signInPage();
			iOSUniversalApp2.AddNewOrderPage();
			Thread.sleep(10000);
			iOSUniversalApp2.createAccountPage();
			Thread.sleep(10000);
			iOSUniversalApp2.patientsProfile();
			Thread.sleep(20000);
			iOSUniversalApp2.patientsPhotosPage();
			iOSUniversalApp2.patientsInsert();
			iOSUniversalApp2.patientsShoe();
			iOSUniversalApp2.patientsMaterials();
			iOSUniversalApp2.shippingAddress();
			Thread.sleep(20000);
			iOSUniversalApp2.orderSummary();
			Thread.sleep(20000);
			wd.switchTo().alert().accept();
