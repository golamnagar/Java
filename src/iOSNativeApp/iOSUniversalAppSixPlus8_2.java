...
public class iOSUniversalAppSixPlus8_2 {
...
public static void main(String[] args) throws Exception {
		iOSUniversalAppSixPlus8_2.setupWebDriver();
		//iOSUniversalApp.signInPage();
		iOSUniversalAppSixPlus8_2.AddNewOrderPage();
		Thread.sleep(10000);
		iOSUniversalAppSixPlus8_2.createAccountPage();
		Thread.sleep(10000);
		iOSUniversalAppSixPlus8_2.patientsProfile();
		Thread.sleep(20000);
		iOSUniversalAppSixPlus8_2.patientsPhotosPage();
		iOSUniversalAppSixPlus8_2.patientsInsert();
		iOSUniversalAppSixPlus8_2.patientsShoe();
		iOSUniversalAppSixPlus8_2.patientsMaterials();
		iOSUniversalAppSixPlus8_2.shippingAddress();
		Thread.sleep(20000);
		iOSUniversalAppSixPlus8_2.orderSummary();
		Thread.sleep(30000);
	//	wd.switchTo().alert().accept();
