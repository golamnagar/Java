 ...
 */
	...
	public static void main(String[] args) {
		try {
			iOSUniversalApp.setupWebDriver();
		//	iOSUniversalApp.signInPage();
			Thread.sleep(10000);
			iOSUniversalApp.AddNewOrderPage();
			Thread.sleep(10000);
			iOSUniversalApp.createAccountPage();
			Thread.sleep(10000);
			iOSUniversalApp.patientsProfile();
			Thread.sleep(20000);
			iOSUniversalApp.patientsPhotosPage();
			iOSUniversalApp.patientsInsert();
			iOSUniversalApp.patientsShoe();
			iOSUniversalApp.patientsMaterials();
			iOSUniversalApp.shippingAddress();
			Thread.sleep(20000);
			iOSUniversalApp.orderSummary();
			Thread.sleep(20000);
			wd.switchTo().alert().accept();
			...
			iOSUniversalApp.sendMail("golam@sols.co",
					"Saktar1982",
					"smtp.gmail.com",
					"465",
					"true",
